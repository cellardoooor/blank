...
func (s *MessageService) MarkMessageAsDelivered(ctx context.Context, messageID, receiverID uuid.UUID) error {
	if s.repo == nil {
		return fmt.Errorf("database unavailable")
	}
	return s.repo.MarkAsDelivered(ctx, messageID, receiverID)
}
